...
<header class="navigation">
    ...
    <section class="page-title bg-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h1>Barangay Police Security Officer</h1>
    ...
    <div class="container">
            ...
            <div class="row mt-30">
                    ...
                    $query = "SELECT * FROM `official_list` WHERE position_id=6 ";
                            ...
                            ?>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-8 ">
                                    <div class="chart-item text-center ">
                                        <img class="img-circle" alt="pic" src="./images/police.png" width="150" height="150">
