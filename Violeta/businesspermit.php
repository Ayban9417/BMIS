    ...
    <section class="page-title bg-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h1>Certificate for Electrification</h1>
    ...
    <section class="chart-table section bg-gray">
        <div class="container">
            <div class="col-md-12 col-sm-4 col-xs-8 ">
                ...
                <form method="POST" action="print_business.php" target="_blank">
                            <div >
                            ...
                            <div >
                                ...
                                <div class="form-group col-md-4">
                                <label for="inputPassword4">CIVIL STATUS</label>
                               
                                <select class="form-control" id="status" placeholder="Status" name="status" required value="">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="purpose" placeholder="Purpose" name="purpose" required value="">
                                    <option value="Business Electrical Installation" >Business Electrical Installation</option>
                                    <option value="House Electrical Installation" >House Electrical Installation</option>
                                    <option value="Building Electrical Installation" >Building Electrical Installation</option>
