        ...
        <div class="container">
            <div class="col-md-12 col-sm-4 col-xs-8 ">
                <div class="chart-item">
                    <form id="myForm" method="POST" action="print_indigency.php" target="_blank">
                        <div >
                        ...
                        <div >
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputOccupation" placeholder="" name="occupation" required value="">
                                </div>
