        ...
        <div class="container">
            <div class="col-md-12 col-sm-4 col-xs-8 ">
                <div class="chart-item">
                    <form id="myForm" method="POST" action="print_residency.php" target="_blank">
                        <div >
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="inputMname" placeholder="Middlename" name="middlename" required value="">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div >
                            ...
                            <input type="date" class="form-control" id="inputBirthdate" placeholder="" name="birthdate" required value="">
                            </div>
                            <div class="form-group col-md-4">
                              ...
                              <div class="form-group col-md-4">
                                <label for="inputOccupation">BIRTHPLACE</label>
                                <input type="text" class="form-control" id="inputbirthplace" placeholder="" name="birthplace" required value="">
                                </div>
                    ...
                    <input type="number" class="form-control" id="inputHeight" placeholder="Height" name="height" required value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputWeight">WEIGHT in(kilos)</label>
                        <input type="number" class="form-control" id="inputWeight" placeholder="Weight" name="weight" required value="">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="inputOccupation">Purpose</label>
                        ...
                        <div class="form-group col-md-12">
                            <label for="inputCity">Purpose</label>
