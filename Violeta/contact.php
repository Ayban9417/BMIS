                ...
                <div class="col-md-6 col-sm-12">
                    <div class="block">
                        ...
                        <ul class="address-block">
                            ...
                            <li>
                                <i class="ion-ios-telephone-outline"></i>Barangay Contact no: 0926-968-0314 / 0975-349-5440
                                </li>  
                            <li>
                                <i class="ion-ios-telephone-outline"></i>TMC No: 0936-829-4691
                            </li>
                            <li>
                                <i class="ion-ios-telephone-outline"></i>City Mayor's Office: (088)-813-5643
                            </li>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="block">
                        <div class="google-map">
                            <div class="map" id="map_canvas" data-latitude="8.0257" data-longitude="125.1544" data-marker="images/marker.png"></div>
                        </div>
                    </div>
                </div>
            </div>
