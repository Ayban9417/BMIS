        ...
        <?php  include('../DBConnection.php'); 
                    ...
                    if($check_official){
                        while($row = mysqli_fetch_array($query_run))
                        {
                            ...
                            ?>
                        <a class="pull-left" href="upcoming.php">
				<?php echo '<img class="media-object" src="../admin/uploads/'.$row['image'].'" alt="Image">' ?>
			</a>
            	
			<div class="media-body">
				<h4 class="media-heading"><a href="upcoming.php"><?php echo $row['title'];  ?></a></h4>
...
<?php  include('../DBConnection.php'); 
                    require('../DBConnection.php');
                    $query = "SELECT * FROM `news` WHERE statuss = 'Current Events'  ORDER BY `date_created` DESC ";
                    $query_run = mysqli_query($conn, $query);
                    $check_official = mysqli_num_rows( $query_run) > 0;
