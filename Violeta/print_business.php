...
<header class="navigation">
        ...
        <section>
            ...
            require('../DBConnection.php');
                ...
                if ($rowss > 0)
                {
                    $query = "INSERT INTO `business_clearance_list` (firstname,lastname,middlename,age,contact,purpose,or_no) VALUES ('$firstname','$lastname','$middlename','$age','$contact','$purpose','$or_no')";
...
<div  id="noscript2" class="container-fluid">
    ...
    <hr>
    <br>
    <h2 class="fw-bold text-center">CERTIFICATE FOR ELECTRIFICATION</h2>
    <br>
    <br>
    <br>
    <br>
