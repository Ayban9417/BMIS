        ...
        <section>
           ...
           // $weight =  $_POST["weight"];
            ...
            $or_no = $_POST["orNum"];
                ...
                if ($rowss > 0)
                {
                    $query = "INSERT INTO `cedula_list` (firstname,lastname,middlename,citezenship,birthday,birthplace,civil_status,purpose,or_no) VALUES ('$firstname','$lastname','$middlename', '$citezenship','$birthday','$birthplace','$civil_status','$purpose','$or_no')";
...
<div  id="noscript2" class="container-fluid">
    ...
    <hr>
    <br>
    <h2 class="fw-bold text-center">FOR IDENTIFICATION</h2>
    <br>
    <br>
    <br>
    <br>
        ...
        <div class="container-fluid">
         ...
         <dl class="row w-100">
            <dt class="text-muted col-md-4">Lastname: <?php echo $firstname ?></dt>
            <dd class="col-md-8"></dd>
            <dt class="text-muted col-md-4">Firstname: <?php echo $lastname ?></dt>
            <dd class="col-md-8"></dd>
        ...
        ?><?php echo $city['baranggay'] ?>, <?php echo $city['city'] ?>, <?php echo $city['province'] ?>, <?php echo $city['code'] ?></dd>
         ...
         <p>
            <span class="ms-5"></span>This is to certify that the above mentioned name</u></b>  a bonafide resident of <?php  echo $city['baranggay'] ?> <?php  echo $city['city'] ?>, <?php  echo $city['province'] ?> is known to be of good moral character and law-abiding citizen in the community.
        </p>
