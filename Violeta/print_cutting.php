        ...
        <section>
            ...
            require('../DBConnection.php');
               ...
               // $status = $_POST["status"];
                ...
                if ($rowss > 0)
                {
                    $query = "INSERT INTO `cutting_trees` (firstname,lastname,middlename,age,contact,purpose,or_no) VALUES ('$firstname','$lastname','$middlename','$age','$contact','$purpose','$or_no')";
...
<div  id="noscript2" class="container-fluid">
    ...
    <hr>
    <br>
    <h2 class="fw-bold text-center">CERTIFICATE FOR MEDICAL ASSISTANCE</h2>
    <br>
    <br>
    <br>
    <br>
        ...
        <p><span class="ms-5"></span>This Certification is being issued upon the request of the above-name person for the requirements of his/her Medical Assistance .
 </p>
