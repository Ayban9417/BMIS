...
<header class="navigation">
        ...
        <section>
            ...
            require('../DBConnection.php');
                ...
                if ($rowss > 0)
                {
                    $query = "INSERT INTO `indigency_list` (firstname,lastname,middlename,age,birthdate,purok_id,occupation,purpose,or_no) VALUES ('$firstname','$lastname','$middlename','$age','$birthdate','$purok_id','$occupation','$purpose','$or_no')";
...
<div  id="noscript2" class="container-fluid">
    ...
    <hr>
    <br>
    <h2 class="fw-bold text-center">Certificate of Indigency</h2>
    <br>
    <br>
    <br>
    <br>
...
<div class="container-fluid">
    <div id="outprint_modal">
        <p>
            <span class="ms-5"></span>This is to certify that <b><u class="px-1"><?php  echo $lastname.', '.$firstname ?></u></b><?php  echo $age ?> years old, Filipino Citizen, is a bonafide  resident of   <?php   echo $city['baranggay'] ?> <?php  echo $city['city'] ?>, <?php  echo $city['province'] ?>.
        </p>
        <p><span class="ms-5"></span>Further certify that the above-named person belongs to the Indigent Family in this Barangay.<br><br>
        This Certification is being issued upon the request of the interested party connection with the requirements for his/her <?php echo $purpose ?>.	
</p>
        <p><span class="ms-5">ISSUED this <b><u class="px-1"><?php echo date("l jS ") ?></u></b> day of <b><u class="px-1"><?php echo date('F Y') ?></u></b> at <?php   echo $city['baranggay'] ?> <?php  echo $city['city'] ?>, <?php  echo $city['province'] ?> upon request of the interested party for whatever legal purposes it may serve.</p>
        <br>
        <br>
        <br>
        <br>
    ...
    <div class="row justify-content-end border-top pt-2">
        ...
        <div class="col-auto">
            <button class="btn btn-sm btn-dark rounded-0" data-bs-dismiss='modal' type="button"  onclick="self.close()"><i class="fa fa-times"></i> Close</button>
        </div>
    </div>    
