...
<header class="navigation">
        ...
        <section>
            ...
            require('../DBConnection.php');
                ...
                if ($rowss > 0)
                {
                    $query = "INSERT INTO `residency_list` (firstname,lastname,middlename,age,birthdate,birthplace,height,weights,purok_id,purpose,or_no) VALUES ('$firstname','$lastname','$middlename','$age','$birthdate','$birthplace','$height','$weight','$purok_id','$purpose','$or_no')";
...
<div  id="noscript2" class="container-fluid">
    ...
    <hr>
    <br>
    <h2 class="fw-bold text-center">Certificate of Residency</h2>
    <br>
    <br>
    <br>
    <br>
...
<div class="container-fluid">
    <div id="outprint_modal">
        <p>
            <span class="ms-5"></span>This is to certify that <b><u class="px-1"><?php echo $lastname.', '.$firstname.', '.$age ?></u></b> years old, is a PERMANENT RESIDENT of this  <?php   echo $city['baranggay'] ?> <?php  echo $city['city'] ?>, <?php  echo $city['province'] ?>.
        </p>
        <p><span class="ms-5"></span>Based on records of this office, she/he has been residing at Barangay Violeta, Malaybalay City.<br><br>
	This CERTIFICATION is being issued upon the request of the above-named person for his/her <?php echo $purpose ?>.
</p>
