...
<header class="navigation">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                        <li><a href="login.php">Barangay<br>Clearance</a></li>
                                            <li><a href="login.php">Certificate of<br>Indigent</a></li>
                                            <li><a href="login.php">Certificate Of<br>Residency</a></li>
                                            <li><a href="login.php">Certificate of<br>Cutting Trees</a></li>
                                            <li><a href="login.php">Business Permit</a></li>
                                            <li><a href="login.php">Cedula</a></li>
                                        </ul>
                                    </li>
    ...
    <section class="page-title bg-2">
     ...
     <section class="section-sm justify-content-center">
  ...
  <div class="row mb-4">
    ...
    <button type="button" class="btn btn-primary btn-lg btn-block mb-4">Sign up</button>
  </div>
