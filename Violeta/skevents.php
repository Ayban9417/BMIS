...
<body id="body">
	...
	<div class="widget widget-latest-post">
        ...
        <?php  include('../DBConnection.php'); 
                    ...
                    $query = "SELECT * FROM `sknews` WHERE statuss = 'Upcoming Sk Events'  ORDER BY `date_created` DESC ";
                    ...
                    if($check_official){
                        while($row = mysqli_fetch_array($query_run))
                        {
                            ...
                            ?>
                        <a class="pull-left" href="skupcoming.php">
				<?php echo '<img class="media-object" src="../admin/uploads/'.$row['image'].'" alt="Image">' ?>
			</a>
            	
			<div class="media-body">
				<h4 class="media-heading"><a href="skupcoming.php"><?php echo $row['title'];  ?></a></h4>
...
<?php  include('../DBConnection.php'); 
                    require('../DBConnection.php');
                    $query = "SELECT * FROM `sknews` WHERE statuss = 'Current Sk Events'  ORDER BY `date_created` DESC ";
                    $query_run = mysqli_query($conn, $query);
                    $check_official = mysqli_num_rows( $query_run) > 0;
...
<div class="post">
	<div class="post-media post-thumb">
		<a href="blog-single.html">
          <?php echo '<img class="img-responsive" src="../admin/uploads/'.$row['image'].'" height="200px" width="500px"  alt="Image">' ?> 
		</a>
	</div>
	...
	<div class="post-meta">
        <ul>
          <li>
          <i class="ion-android-calendar"><?php echo $row['date_created'];  ?></i>
          </li>
          <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p style="text-align: center;" class="copyright">Copyright 2022 &copy; Design & Developed by <a>BSU BSIT Students</a>. All rights reserved.
