<?php  $position = $conn->query("SELECT * from `system_infos` where id = 1 ");
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Certificate of Electrification</h3>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                <?php 
                $sql = "SELECT * FROM business_clearance_list order by `lastname` asc";
                $qry = $conn->query($sql);
                $i = 1;
...
<noscript>
    <div class="d-flex w-100 align-items-center">
        ...
        ?><?php echo $city['city'] ?></p>
            ...
            <p class="fw-bold text-center">Certificate for Electrification</p>
        </div>
        <div class="col-2">
...
<script>
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./../Actions.php?a=delete_business',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
