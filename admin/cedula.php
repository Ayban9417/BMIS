...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">FOR NATIONAL ID</h3>
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Civil Status</th>
                    <th class="text-center p-0">Age</th>
                    <th class="text-center p-0">Remakrs</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $sql = "SELECT *,(lastname) as fullname,(firstname) as fname,birthday,TIMESTAMPDIFF(YEAR, birthday, CURDATE()) AS age FROM cedula_list order by `fullname` asc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-0 px-1"><?php echo $row['civil_status'] ?></td>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item view_data" data-id="<?php echo $row['cedula_id'] ?>" href="javascript:void(0)">View</a></li>
                            <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['cedula_id'] ?>' href="javascript:void(0)">Edit</a></li>
...
<noscript>
    <div class="d-flex w-100 align-items-center">
        ...
        ?><?php echo $city['city'] ?></p>
            ...
            <p class="fw-bold text-center">FOR VALID ID</p>
        </div>
        <div class="col-2">
...
<script>
    ...
    $(function(){
        ...
        $('#create_new').click(function(){
            uni_modal('Add Cedula',"manage_cedula.php",'mid-large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Cedula\'s Details',"manage_cedula.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.view_data').click(function(){
            uni_modal('Cedula Details',"view_cedula.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.delete_data').click(function(){
            _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from Ceddula List?",'delete_data',[$(this).attr('data-id')])
        })
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./../Actions.php?a=delete_cedula',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
