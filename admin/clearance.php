...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Certificate for Loan</h3>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                <?php 
                $sql = "SELECT *,(lastname) as fullname,(firstname) as fname  FROM clearance_list order by `fullname` asc";
                $qry = $conn->query($sql);
                $i = 1;
...
<noscript>
    <div class="d-flex w-100 align-items-center">
        ...
        ?><?php echo $city['city'] ?></p>
            ...
            <p class="fw-bold text-center">Certificate for Loan</p>
        </div>
        <div class="col-2">
