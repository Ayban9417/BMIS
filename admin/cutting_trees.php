...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Certificate for Medical Assistance List</h3>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                <?php 
                $sql = "SELECT *,(lastname) as fullname,(firstname) as fname  FROM cutting_trees order by `fullname` asc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item view_data" data-id="<?php echo $row['cutting_id'] ?>" href="javascript:void(0)">View</a></li>
                            <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['cutting_id'] ?>' href="javascript:void(0)">Edit</a></li>
...
<noscript>
    <div class="d-flex w-100 align-items-center">
        ...
        ?><?php echo $city['city'] ?></p>
            ...
            <p class="fw-bold text-center">Certificate for Medical Assistance List</p>
        </div>
        <div class="col-2">
...
<script>
    ...
    $(function(){
        ...
        $('#create_new').click(function(){
            uni_modal('Add Clearance',"manage_cutting.php",'mid-large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Clearance\'s Details',"manage_cutting.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.view_data').click(function(){
            uni_modal('Clearance Details',"view_cutting.php?id="+$(this).attr('data-id'),'mid-large')
        })
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./../Actions.php?a=delete_cutting',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
