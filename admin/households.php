    ...
    <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Household Number</th>
                    <th class="text-center p-0">Head of the Household</th>
                    <th class="text-center p-0">Address</th>
                    <th class="text-center p-0">Number of Members</th>
                    <th class="text-center p-0">Members</th>
            ...
            <tbody>
                ...
                $sql = mysqli_query($conn, "SELECT  h.*,(h.house_no) as fullname,CONCAT(h.lastname, ', ' ,h.firstname) as Lastnames, GROUP_CONCAT(h.firstname, ' ' , h.lastname) as Lastname, p.purok,COUNT(h.house_no) as total FROM household_list h inner join `purok_list` p on h.purok_id = p.purok_id GROUP BY `house_no`");
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-0 px-1"><?php echo $row['house_no'] ?></td>
                    ...
                    <td class="py-0 px-1"><?php echo $row['total'] ?></td>
                    <td class="py-0 px-1 lh-1">
                    <?php 
                  ...
                  echo ucfirst($row['Lastname'])?>
                        ...
                        <!-- <small><span class="text-muted">Purok: </span><?php echo $row['Lastname'] ?></small> -->
                    </td>
...
<script>
    ...
    $(function(){
        ...
        $('.view_data').click(function(){
            uni_modal('Household Details',"view_households.php?id="+$(this).attr('data-id'),'mid-large')
        })
