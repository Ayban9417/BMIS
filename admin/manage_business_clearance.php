...
<script>
    $(function(){
        $('#business_clearance-form').submit(function(e){
            // ----------------------------REQUIRED FIELD---------------------------------
         let x = document.forms["business_clearance-form"]["lastname"].value;
            let y = document.forms["business_clearance-form"]["firstname"].value;
  if (x == "" || y == "") {
    ...
    // ---------------------------END------------------------------------------------
            ...
            $.ajax({
                url:'./../Actions.php?a=save_business',
