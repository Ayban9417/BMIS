...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM `indigency_list` where indigency_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    <form action="" id="indigency-form">
        <input type="hidden" name="id" value="<?php echo isset($indigency_id) ? $indigency_id : '' ?>">
        ...
        <div class="form-group">
            <label for="birthdate" class="control-label">Occupation</label>
        ...
        <div class="form-group">
                            ...
                            <select class="form-control" id="purpose" placeholder="Purpose" name="purpose" required value="">
                                    <option value="Avail Assistant" >Financial Assistance</option>
                                    <option value="Medical Services" >Medical Services</option>
                                    <option value="Scholarship" >Scholarship</option>
                                    <option value="Legal Aid From Public Attorney">Legal Aid From Public Attorney</option>
...
<script>
    $(function(){
        $('#indigency-form').submit(function(e){
            // ----------------------------REQUIRED FIELD---------------------------------
         let x = document.forms["indigency-form"]["lastname"].value;
            let y = document.forms["indigency-form"]["firstname"].value;
  if (x == "" || y == "") {
    ...
    // ---------------------------END------------------------------------------------
            ...
            $.ajax({
                url:'./../Actions.php?a=save_indigency',
