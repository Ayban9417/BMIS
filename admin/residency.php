...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Certificate of Residency List</h3>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                <?php 
                $sql = "SELECT *,(lastname) as fullname,(firstname) as fname  FROM residency_list order by `fullname` asc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-0 px-1"><?php echo $row['age'] ?></td>
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <li><a class="dropdown-item view_data" data-id="<?php echo $row['residency_id'] ?>" href="javascript:void(0)">View</a></li>
                            <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['residency_id'] ?>' href="javascript:void(0)">Edit</a></li>
...
<noscript>
    <div class="d-flex w-100 align-items-center">
        ...
        ?><?php echo $city['city'] ?></p>
            ...
            <p class="fw-bold text-center">Certificate of Residency</p>
        </div>
        <div class="col-2">
...
<script>
    ...
    $(function(){
        ...
        $('#create_new').click(function(){
            uni_modal('Add Residency',"manage_residency.php",'mid-large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Residency\'s Details',"manage_residency.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.view_data').click(function(){
            uni_modal('Clearance Residency',"view_residency.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.delete_data').click(function(){
            _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from Residency List?",'delete_data',[$(this).attr('data-id')])
        })
    ...
    function delete_data($id){
        ...
        $.ajax({
            url:'./../Actions.php?a=delete_residency',
            method:'POST',
            data:{id:$id},
            dataType:'JSON',
            error:err=>{
