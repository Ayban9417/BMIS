...
<div class="card">
    ...
    <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                ...
                $sql = mysqli_query($conn, "SELECT  h.*,(h.firstname) as fullname,(h.lastname) as Lastname, p.purok,v.vaccine,birthday,TIMESTAMPDIFF(YEAR, birthday, CURDATE()) AS age FROM household_list h inner join `purok_list` p on h.purok_id = p.purok_id inner join `vaccine_list` v on h.vaccine_id = v.vaccine_id HAVING age >= '13' and age <= '19' order by `fullname` asc");
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-0 px-1"><?php echo $row['firstname'] ?></td>
                    <td class="py-0 px-1"><?php echo $row['Lastname'] ?></td>
