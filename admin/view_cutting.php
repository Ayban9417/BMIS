...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT *,(lastname) as fullname,(firstname) as fname FROM cutting_trees where cutting_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    ...
    <p>
        ...
        <dl class="row">
            ...
            <dd class='col-3 border-bottom'><?php echo(rand()); ?></dd>
        </dl>
        <dl class="row">
