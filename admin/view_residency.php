...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT *,(lastname) as fullname,(firstname) as fname FROM residency_list where residency_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    <div id="outprint_modal">
        <p>
            <span class="ms-5"></span>This is to certify that <b><u class="px-1"><?php  session_start(); echo $fullname.', '.$fname.', '.$age ?></u></b> years old, is a PERMANENT RESIDENT of this  <?php   echo $city['baranggay'] ?> <?php  echo $city['city'] ?>, <?php  echo $city['province'] ?>.
        </p>
